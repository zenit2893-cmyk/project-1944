...
> **Релиз 1.0:** скачайте `cod3-pc-full.zip` и `SHA256SUMS.txt` на странице [Releases](https://github.com/zenit2893-cmyk/project-1944/releases) этого репозитория. Здесь хранятся исходники; для игры нужна собственная легально приобретённая копия Xbox 360-версии.
...
## Быстрый старт для релиза 1.0

Полная инструкция: [English](INSTALL_EN.md) · [Русский](INSTALL_RU.md) · [Українська](INSTALL_UK.md).
