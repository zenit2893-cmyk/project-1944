...
// cod3-pc/generated/default/cod3_pc_recomp.23.cpp:16666 sub_8231C6C0
__declspec(noinline) inline PPCVRegister unpack_half2_alias(PPCVRegister a) {
  PPCContext ctx{}; PPCRegister temp{}; PPCVRegister vTemp{};
  ctx.fpscr.InitHost();
  ctx.fpscr.enableFlushModeUnconditional();
  ctx.v0 = a;
	...
	ctx.v0.u32[3] = vTemp.u32[0];
	temp.u32 = ctx.v0.u16[0];
	vTemp.u32[0] = ((temp.u32 & 0x8000) << 16) | (((temp.u32 & 0x7C00) + 0x1C000) << 13) | ((temp.u32 & 0x03FF) << 13);
	if ((temp.u32 & 0x7C00) == 0) vTemp.u32[0] = (temp.u32 & 0x8000) << 16;
	ctx.v0.u32[2] = vTemp.u32[0];
	ctx.v0.f32[1] = 0.0f;
	ctx.v0.f32[0] = 1.0f;
  return ctx.v0;
}
// cod3-pc/generated/default/cod3_pc_recomp.48.cpp:17983 sub_823635F0
__declspec(noinline) inline PPCVRegister unpack_half4_alias(PPCVRegister a) {
  PPCContext ctx{}; PPCRegister temp{}; PPCVRegister vTemp{};
  ctx.fpscr.InitHost();
  ctx.fpscr.enableFlushModeUnconditional();
  ctx.v0 = a;
	...
	vTemp.u32[0] = ((temp.u32 & 0x8000) << 16) | (((temp.u32 & 0x7C00) + 0x1C000) << 13) | ((temp.u32 & 0x03FF) << 13);
	if ((temp.u32 & 0x7C00) == 0) vTemp.u32[0] = (temp.u32 & 0x8000) << 16;
	ctx.v0.u32[1] = vTemp.u32[0];
	temp.u32 = ctx.v0.u16[0];
	vTemp.u32[0] = ((temp.u32 & 0x8000) << 16) | (((temp.u32 & 0x7C00) + 0x1C000) << 13) | ((temp.u32 & 0x03FF) << 13);
	if ((temp.u32 & 0x7C00) == 0) vTemp.u32[0] = (temp.u32 & 0x8000) << 16;
	ctx.v0.u32[0] = vTemp.u32[0];
  return ctx.v0;
}
}  // namespace actual
