...
> **Реліз 1.0:** завантажте `cod3-pc-full.zip` і `SHA256SUMS.txt` зі сторінки [Releases](https://github.com/zenit2893-cmyk/project-1944/releases) цього репозиторію. Тут зберігається вихідний код; для гри потрібна власна законно придбана копія версії для Xbox 360.
...
## Швидкий початок для релізу 1.0

Повна інструкція: [English](INSTALL_EN.md) · [Русский](INSTALL_RU.md) · [Українська](INSTALL_UK.md).
...
4. Натисніть **«Встановити й грати»**. Лаунчер перевірить джерело, скопіює його локально до `game\cod3` і виконає перевірку перекомпіляції.
